...
We are pleased to submit our manuscript, ``Reproducible AI-driven planning for county-scale farmland consolidation: from cadastral data to optimised plans on a desktop CPU,'' for consideration as a Research Article in \textit{Communications Earth \& Environment}.
