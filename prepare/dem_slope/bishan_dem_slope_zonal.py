...
Required env vars (or edit the constants directly):
    BISHAN_GDB_PATH       -> .gdb directory containing DLTB layer
    BISHAN_XIANGZHEN_PATH -> township boundary shapefile
    BISHAN_OUTPUT_DIR     -> writable working dir for intermediate + output
"""
...
GDB_PATH = Path(os.environ.get("BISHAN_GDB_PATH", "/path/to/bishan/GDB.gdb"))
LAYER_NAME = "DLTB"
XIANGZHEN_PATH = Path(os.environ.get("BISHAN_XIANGZHEN_PATH", "/path/to/bishan/xiangzhen.shp"))

OUTPUT_DIR = Path(os.environ.get(
    "BISHAN_OUTPUT_DIR",
    str(Path(__file__).resolve().parent / "bishan_run"),
))
